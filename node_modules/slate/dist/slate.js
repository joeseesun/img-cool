(function (global, factory) {
  ...
  var insertChildren = function insertChildren(xs, index) {
    ...
    return [].concat(_toConsumableArray(xs.slice(0, index)), newValues, _toConsumableArray(xs.slice(index)));
  };
  var replaceChildren = function replaceChildren(xs, index, removeCount) {
    ...
    return [].concat(_toConsumableArray(xs.slice(0, index)), newValues, _toConsumableArray(xs.slice(index + removeCount)));
  };
  var removeChildren = replaceChildren;
  /**
   * Replace a descendant with a new node, replacing all ancestors
   */
  var modifyDescendant = function modifyDescendant(editor, path, f) {
    if (path.length === 0) {
   ...
   */
  var modifyChildren = function modifyChildren(editor, path, f) {
    if (path.length === 0) {
      editor.children = f(editor.children);
    } else {
      modifyDescendant(editor, path, function (node) {
        if (Text.isText(node)) {
   ...
   */
  var modifyLeaf = function modifyLeaf(editor, path, f) {
    return modifyDescendant(editor, path, function (node) {
      if (!Text.isText(node)) {
  ...
  var GeneralTransforms = {
    transform: function transform(editor, op) {
        ...
        case 'remove_node':
          {
            ...
            modifyChildren(editor, Path.parent(_path4), function (children) {
              return removeChildren(children, _index3, 1);
            });
              ...
              try {
                for (_iterator.s(); !(_step = _iterator.n()).done;) {
                  ...
                  if (selection != null && result != null) {
                    ...
                    var prev = void 0;
                    var next = void 0;
                    var _iterator2 = _createForOfIteratorHelper$l(Node.texts(editor)),
                      _step2;
                    try {
      ...
      if (transformSelection && editor.selection) {
        ...
        var _iterator3 = _createForOfIteratorHelper$l(Range.points(_selection2)),
          _step3;
        try {
          for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
            var _step3$value = _slicedToArray(_step3.value, 2),
              _point = _step3$value[0],
              _key6 = _step3$value[1];
  ...
  function nodes(editor) {
    var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
    return /*#__PURE__*/regenerator.mark(function _callee() {
      var _options$at, at, _options$mode, mode, _options$universal, universal, _options$reverse, reverse, _options$voids, voids, _pass, _options$ignoreNonSel, ignoreNonSelectable, match, from, to, first, last, nodeEntries, matches, hit, _iterator, _step, _step$value, node, path, isLower, emit;
      return regenerator.wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _options$at = options.at, at = _options$at === void 0 ? editor.selection : _options$at, _options$mode = options.mode, mode = _options$mode === void 0 ? 'all' : _options$mode, _options$universal = options.universal, universal = _options$universal === void 0 ? false : _options$universal, _options$reverse = options.reverse, reverse = _options$reverse === void 0 ? false : _options$reverse, _options$voids = options.voids, voids = _options$voids === void 0 ? false : _options$voids, _pass = options.pass, _options$ignoreNonSel = options.ignoreNonSelectable, ignoreNonSelectable = _options$ignoreNonSel === void 0 ? false : _options$ignoreNonSel;
            match = options.match;
            if (!match) {
              match = function match() {
                return true;
    ...
    Editor.withoutNormalizing(editor, function () {
      ...
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          ...
          if (starting && Element.isElement(node) && !editor.isInline(node) && !Path.isAncestor(_path, firstLeafPath)) {
            starting = false;
          }
      ...
      Transforms.splitNodes(editor, {
        at: at,
        match: function match(n) {
          return splitBlock ? Element.isElement(n) && Editor.isBlock(editor, n) : Text.isText(n) || Editor.isInline(editor, n);
        },
