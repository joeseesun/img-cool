...
// ../../node_modules/@plait/draw/fesm2022/plait-draw.mjs
var import_is_hotkey = __toESM(require_lib(), 1);
var BasicShapes;
(function(BasicShapes2) {
  BasicShapes2["rectangle"] = "rectangle";
  BasicShapes2["ellipse"] = "ellipse";
  BasicShapes2["diamond"] = "diamond";
  BasicShapes2["roundRectangle"] = "roundRectangle";
  BasicShapes2["parallelogram"] = "parallelogram";
  BasicShapes2["text"] = "text";
  BasicShapes2["triangle"] = "triangle";
  BasicShapes2["leftArrow"] = "leftArrow";
  BasicShapes2["trapezoid"] = "trapezoid";
  BasicShapes2["rightArrow"] = "rightArrow";
  BasicShapes2["cross"] = "cross";
  BasicShapes2["star"] = "star";
  BasicShapes2["pentagon"] = "pentagon";
  BasicShapes2["hexagon"] = "hexagon";
  BasicShapes2["octagon"] = "octagon";
  BasicShapes2["pentagonArrow"] = "pentagonArrow";
  BasicShapes2["processArrow"] = "processArrow";
  BasicShapes2["twoWayArrow"] = "twoWayArrow";
  BasicShapes2["comment"] = "comment";
  BasicShapes2["roundComment"] = "roundComment";
  BasicShapes2["cloud"] = "cloud";
})(BasicShapes || (BasicShapes = {}));
var FlowchartSymbols;
(function(FlowchartSymbols2) {
  FlowchartSymbols2["process"] = "process";
  FlowchartSymbols2["decision"] = "decision";
  FlowchartSymbols2["data"] = "data";
  FlowchartSymbols2["connector"] = "connector";
  FlowchartSymbols2["terminal"] = "terminal";
  FlowchartSymbols2["manualInput"] = "manualInput";
  FlowchartSymbols2["preparation"] = "preparation";
  FlowchartSymbols2["manualLoop"] = "manualLoop";
  FlowchartSymbols2["merge"] = "merge";
  FlowchartSymbols2["delay"] = "delay";
  FlowchartSymbols2["storedData"] = "storedData";
  FlowchartSymbols2["or"] = "or";
  FlowchartSymbols2["summingJunction"] = "summingJunction";
  FlowchartSymbols2["predefinedProcess"] = "predefinedProcess";
  FlowchartSymbols2["offPage"] = "offPage";
  FlowchartSymbols2["document"] = "document";
  FlowchartSymbols2["multiDocument"] = "multiDocument";
  FlowchartSymbols2["database"] = "database";
  FlowchartSymbols2["hardDisk"] = "hardDisk";
  FlowchartSymbols2["internalStorage"] = "internalStorage";
  FlowchartSymbols2["noteCurlyRight"] = "noteCurlyRight";
  FlowchartSymbols2["noteCurlyLeft"] = "noteCurlyLeft";
  FlowchartSymbols2["noteSquare"] = "noteSquare";
  FlowchartSymbols2["display"] = "display";
})(FlowchartSymbols || (FlowchartSymbols = {}));
var UMLSymbols;
(function(UMLSymbols2) {
  UMLSymbols2["actor"] = "actor";
  UMLSymbols2["useCase"] = "useCase";
  UMLSymbols2["container"] = "container";
  UMLSymbols2["note"] = "note";
  UMLSymbols2["simpleClass"] = "simpleClass";
  UMLSymbols2["activityClass"] = "activityClass";
  UMLSymbols2["branchMerge"] = "branchMerge";
  UMLSymbols2["port"] = "port";
  UMLSymbols2["package"] = "package";
  UMLSymbols2["combinedFragment"] = "combinedFragment";
  UMLSymbols2["class"] = "class";
  UMLSymbols2["interface"] = "interface";
  UMLSymbols2["object"] = "object";
  UMLSymbols2["component"] = "component";
  UMLSymbols2["componentBox"] = "componentBox";
  UMLSymbols2["template"] = "template";
  UMLSymbols2["activation"] = "activation";
  UMLSymbols2["deletion"] = "deletion";
  UMLSymbols2["assembly"] = "assembly";
  UMLSymbols2["providedInterface"] = "providedInterface";
  UMLSymbols2["requiredInterface"] = "requiredInterface";
})(UMLSymbols || (UMLSymbols = {}));
var GeometryCommonTextKeys;
(function(GeometryCommonTextKeys2) {
  GeometryCommonTextKeys2["name"] = "name";
  GeometryCommonTextKeys2["content"] = "content";
})(GeometryCommonTextKeys || (GeometryCommonTextKeys = {}));
var PlaitGeometry = {};
var SwimlaneSymbols;
(function(SwimlaneSymbols2) {
  SwimlaneSymbols2["swimlaneVertical"] = "swimlaneVertical";
  SwimlaneSymbols2["swimlaneHorizontal"] = "swimlaneHorizontal";
})(SwimlaneSymbols || (SwimlaneSymbols = {}));
var SwimlaneDrawSymbols;
(function(SwimlaneDrawSymbols2) {
  SwimlaneDrawSymbols2["swimlaneVertical"] = "swimlaneVertical";
  SwimlaneDrawSymbols2["swimlaneHorizontal"] = "swimlaneHorizontal";
  SwimlaneDrawSymbols2["swimlaneVerticalWithHeader"] = "swimlaneVerticalWithHeader";
  SwimlaneDrawSymbols2["swimlaneHorizontalWithHeader"] = "swimlaneHorizontalWithHeader";
})(SwimlaneDrawSymbols || (SwimlaneDrawSymbols = {}));
var TableSymbols;
(function(TableSymbols2) {
  TableSymbols2["table"] = "table";
})(TableSymbols || (TableSymbols = {}));
var PlaitTableElement = {
  isTable: (value) => {
    return value.type === "table";
  },
  isVerticalText: (value) => {
    var _a;
    return ((_a = value.text) == null ? void 0 : _a.direction) === "vertical";
  }
};
var WithDrawPluginKey = "plait-draw-plugin-key";
var DrawI18nKey;
(function(DrawI18nKey2) {
  DrawI18nKey2["lineText"] = "line-text";
  DrawI18nKey2["geometryText"] = "geometry-text";
})(DrawI18nKey || (DrawI18nKey = {}));
var ShapeDefaultSpace = {
  rectangleAndText: 4
};
...
var DefaultDrawActiveStyle = {
  strokeWidth: ACTIVE_STROKE_WIDTH,
  selectionStrokeWidth: ACTIVE_STROKE_WIDTH
};
var DefaultBasicShapeProperty = {
  width: 100,
  height: 100,
  strokeColor: DEFAULT_COLOR,
  strokeWidth: 2
};
var DefaultPentagonArrowProperty = {
  width: 120,
  height: 50
};
var DefaultTwoWayArrowProperty = {
  width: 138,
  height: 80
};
var DefaultArrowProperty = {
  width: 100,
  height: 80
};
...
var GeometryThreshold = {
  defaultTextMaxWidth: 34 * 14
};
var DefaultConnectorProperty = {
  width: 44,
  height: 44
};
var DefaultFlowchartProperty = {
  width: 120,
  height: 60
};
var DefaultDataBaseProperty = {
  width: 70,
  height: 80
};
var DefaultInternalStorageProperty = {
  width: 80,
  height: 80
};
var DefaultDecisionProperty = {
  width: 140,
  height: 70
};
var DefaultDataProperty = {
  width: 124,
  height: 60
};
var DefaultDocumentProperty = {
  width: 120,
  height: 70
};
var DefaultNoteProperty = {
  width: 160,
  height: 100
};
var DefaultMultiDocumentProperty = {
  width: 120,
  height: 80
};
var DefaultManualInputProperty = {
  width: 117,
  height: 59
};
var DefaultMergeProperty = {
  width: 47,
  height: 33
};
var DefaultActorProperty = {
  width: 68,
  height: 100
};
var DefaultContainerProperty = {
  width: 300,
  height: 240
};
var DefaultPackageProperty = {
  width: 210,
  height: 150,
  texts: [
    {
...
var DefaultActivationProperty = {
  width: 18,
  height: 80
};
var DefaultObjectProperty = {
  width: 120,
  height: 60
};
var DefaultComponentBoxProperty = {
  width: 200,
  height: 150
};
var DefaultDeletionProperty = {
  width: 40,
  height: 40
};
var DefaultPortProperty = {
  width: 20,
  height: 20
};
var DefaultRequiredInterfaceProperty = {
  width: 70,
  height: 56
};
var DefaultAssemblyProperty = {
  width: 120,
  height: 56
};
var DefaultProvidedInterfaceProperty = {
  width: 70,
  height: 34
};
var DefaultCombinedFragmentProperty = {
  width: 400,
  height: 280,
  texts: [
    {
...
var DefaultBasicShapePropertyMap = {
...
var DefaultFlowchartPropertyMap = {
...
var MultipleTextGeometryTextKeys = {
  [UMLSymbols.package]: Object.keys(GeometryCommonTextKeys),
  [UMLSymbols.combinedFragment]: Object.keys(GeometryCommonTextKeys)
};
var LINE_HIT_GEOMETRY_BUFFER = 10;
var LINE_SNAPPING_BUFFER = 6;
var LINE_SNAPPING_CONNECTOR_BUFFER = 8;
var GEOMETRY_WITHOUT_TEXT = [
  FlowchartSymbols.or,
...
var GEOMETRY_WITH_MULTIPLE_TEXT = [UMLSymbols.package, UMLSymbols.combinedFragment];
var GEOMETRY_NOT_CLOSED = [
...
var SWIMLANE_HEADER_SIZE = 42;
var DefaultSwimlaneVerticalWithHeaderProperty = {
  width: 580,
  height: 524
};
var DefaultSwimlaneHorizontalWithHeaderProperty = {
  width: 524,
  height: 580
};
var DefaultSwimlaneVerticalProperty = {
  width: 580,
  height: 524
};
var DefaultSwimlaneHorizontalProperty = {
  width: 524,
  height: 580
};
var DefaultSwimlanePropertyMap = {
...
var MIN_TEXT_WIDTH = 5;
var DefaultLineStyle = {
  strokeWidth: 2,
  strokeColor: "#000"
};
var LINE_TEXT_SPACE = 4;
var LINE_AUTO_COMPLETE_DIAMETER = 6;
var LINE_AUTO_COMPLETE_OPACITY = 1;
var LINE_AUTO_COMPLETE_HOVERED_OPACITY = 1;
var LINE_AUTO_COMPLETE_HOVERED_DIAMETER = 12;
var LINE_ALIGN_TOLERANCE = 3;
var LINE_TEXT = "文本";
var KEY_TO_TEXT_MANAGE = /* @__PURE__ */ new WeakMap();
var setTextManage = (board, element, text, textManage) => {
  ...
  update(element, previousDrawShapeTexts, currentDrawShapeTexts, elementG) {
    ...
    if (removedTexts.length) {
      removedTexts.forEach((item) => {
        ...
        textManage == null ? void 0 : textManage.destroy();
...
var SELECTED_CELLS = /* @__PURE__ */ new WeakMap();
...
function getCellsWithPoints(board, element) {
  const table = board == null ? void 0 : board.buildTable(element);
...
function getTextManageByCell(board, cell) {
  return getTextManage(board, void 0, cell);
}
var updateColumns = (table, columnId, width, offset) => {
...
var updateRows = (table, rowId, height, offset) => {
...
var createCell = (rowId, columnId, text = null) => {
  const cell = {
    id: idCreator(),
    rowId,
    columnId
...
var getSelectedTableCellsEditor = (board) => {
  if (isSingleSelectTable(board)) {
    const elements = getSelectedTableElements(board);
    const selectedCells = getSelectedCells(elements[0]);
    const selectedCellsEditor = selectedCells == null ? void 0 : selectedCells.map((cell) => {
      const textManage = getTextManageByCell(board, cell);
      return textManage == null ? void 0 : textManage.editor;
    });
    if (selectedCellsEditor == null ? void 0 : selectedCellsEditor.length) {
      return selectedCellsEditor;
    }
  }
  return void 0;
};
var SHAPE_MAX_LENGTH = 6;
var memorizedShape = /* @__PURE__ */ new WeakMap();
var getMemorizeKey = (element) => {
  let key = "";
  switch (true) {
...
var getLineMemorizedLatest = () => {
  const properties = getMemorizedLatest(MemorizeKey.arrowLine);
  return { ...properties };
};
var getMemorizedLatestByPointer = (pointer) => {
  let memorizeKey = "";
...
var memorizeLatestText = (element, operations) => {
  var _a;
  const memorizeKey = getMemorizeKey(element);
  let textMemory = ((_a = getMemorizedLatest(memorizeKey)) == null ? void 0 : _a.text) || {};
...
var memorizeLatestShape = (board, shape) => {
  const shapes2 = memorizedShape.has(board) ? memorizedShape.get(board) : [];
  const shapeIndex = shapes2.indexOf(shape);
  if (shape === BasicShapes.text || shapeIndex === 0) {
    return;
  }
  if (shapeIndex !== -1) {
    shapes2.splice(shapeIndex, 1);
  } else {
    if (shapes2.length === SHAPE_MAX_LENGTH) {
      shapes2.pop();
    }
  }
  shapes2.unshift(shape);
  memorizedShape.set(board, shapes2);
};
var getMemorizedLatestShape = (board) => {
  return memorizedShape.get(board);
};
var debugKey$4 = "debug:plait:line-mirror";
var debugGenerator$4 = createDebugGenerator(debugKey$4);
var alignPoints = (basePoint, movingPoint) => {
...
function getResizedPreviousAndNextPoint(nextRenderPoints, sourcePoint, targetPoint, handleIndex) {
  ...
  if (isHorizontal && Point.isHorizontal(beforePreviousPoint, previousPoint) || isVertical && Point.isVertical(beforePreviousPoint, previousPoint)) {
...
function getIndexAndDeleteCountByKeyPoint(board, element, dataPoints, nextRenderPoints, handleIndex) {
  ...
  if (Math.max(startIndex, endIndex) > -1) {
    ...
    if (startIndex > -1 && endIndex === -1) {
      const isReplace = startIndex < midDataPoints.length - 1 && Point.isAlign([midDataPoints[startIndex], midDataPoints[startIndex + 1], startKeyPoint, endKeyPoint]);
      if (isReplace) {
        return {
          index: startIndex,
          deleteCount: 2
...
var adjustByCustomPointStartIndex = (board, customPointStartIndex, nextDataPoints, nextKeyPoints, params) => {
...
var hasIllegalElbowPoint = (midDataPoints) => {
...
var ARROW_LENGTH = 20;
var drawArrowLineArrow = (element, points, options) => {
...
var getArrow = (element, arrowOptions, options) => {
...
var drawSharpArrow = (source, target, options) => {
  ...
  path.setAttribute("fill", `${options == null ? void 0 : options.stroke}`);
  g.appendChild(path);
  return g;
};
var drawArrow = (element, source, target, options) => {
...
var drawSolidTriangle = (source, target, options) => {
  const endPoint = target;
  const { pointLeft, pointRight } = arrowPoints(source, endPoint, 30);
  return drawLinearPath([pointLeft, endPoint, pointRight], { ...options, fill: options.stroke }, true);
};
var drawOpenTriangle = (element, source, target, options) => {
  const unitVector = getUnitVectorByPointAndPoint(source, target);
  const strokeWidth = getStrokeWidthByElement(element);
  const endPoint = [target[0] + strokeWidth * unitVector[0] / 2, target[1] + strokeWidth * unitVector[1] / 2];
...
var drawHollowTriangleArrow = (source, target, options) => {
...
var ArrowLineShapeGenerator = class extends Generator {
  canDraw(element) {
    return true;
  }
  draw(element) {
...
var createArrowLineElement = (shape, points, source, target, texts, options) => {
  return {
    id: idCreator(),
    type: "arrow-line",
    shape,
...
var getArrowLinePoints = (board, element) => {
...
var getCurvePoints = (board, element) => {
...
var drawArrowLine = (board, element) => {
  const strokeWidth = getStrokeWidthByElement(element);
...
var getHitConnection = (board, point, hitElement) => {
...
var getHitConnectorPoint = (point, hitElement) => {
...
var getArrowLineTextRectangle = (board, element, index) => {
...
var handleArrowLineCreating = (board, lineShape, sourcePoint, movingPoint, sourceElement, lineShapeG, options) => {
  const hitElement = getSnappingShape(board, movingPoint);
  const targetConnection = hitElement ? getHitConnection(board, movingPoint, hitElement) : void 0;
  const sourceConnection = sourceElement ? getHitConnection(board, sourcePoint, sourceElement) : void 0;
  const targetBoundId = hitElement ? hitElement.id : void 0;
  ...
  const temporaryLineElement = createArrowLineElement(lineShape, [sourcePoint, movingPoint], { marker: sourceMarker || ArrowLineMarkerType.none, connection: sourceConnection, boundId: sourceElement == null ? void 0 : sourceElement.id }, { marker: targetMarker || ArrowLineMarkerType.arrow, connection: targetConnection, boundId: targetBoundId }, [], {
...
var getHitArrowLineTextIndex = (board, element, point) => {
  const texts = element.texts;
  if (!texts.length)
    return -1;
  const points = getArrowLinePoints(board, element);
...
var buildDefaultTextsByShape = (shape) => {
  var _a;
  const memorizedLatest = getMemorizedLatestByPointer(shape);
  const textProperties = { ...memorizedLatest.textProperties };
  const alignment = textProperties == null ? void 0 : textProperties.align;
  const textHeight = (textProperties == null ? void 0 : textProperties.textHeight) || DefaultTextProperty.height;
  textProperties == null ? true : delete textProperties.align;
  textProperties == null ? true : delete textProperties.textHeight;
  const defaultTexts = ((_a = getDefaultGeometryProperty(shape)) == null ? void 0 : _a.texts) || [];
  const textKeys = getMultipleTextGeometryTextKeys(shape);
  return (textKeys || []).map((textKey) => {
    const text = defaultTexts == null ? void 0 : defaultTexts.find((item) => (item == null ? void 0 : item.key) === textKey);
    return {
      id: textKey,
      text: buildText((text == null ? void 0 : text.text) || "", alignment || (text == null ? void 0 : text.align) || Alignment.center, textProperties),
      textHeight
    };
  });
};
var getHitMultipleGeometryText = (element, point) => {
...
var VectorLineShapeGenerator = class extends Generator {
  canDraw(element) {
    return true;
  }
  draw(element) {
...
var getVectorLinePoints = (board, element) => {
  switch (element.shape) {
...
var createVectorLineElement = (shape, points, options) => {
  return {
    id: idCreator(),
    type: "vector-line",
    shape,
...
var vectorLineCreating = (board, lineShape, points, movingPoint, lineShapeG) => {
...
var drawVectorLine = (board, element) => {
  const strokeWidth = getStrokeWidthByElement(element);
  const strokeColor = getStrokeColorByElement(board, element);
  const strokeStyle = getStrokeStyleByElement(board, element);
  const strokeLineDash = getStrokeLineDash(strokeStyle, strokeWidth);
...
var getCenterPointsOnPolygon$1 = (points) => {
  const centerPoints = [];
...
var getCrossingPointBetweenPointAndPolygon = (corners, point) => {
  const result = [];
...
var getPolygonEdgeByConnectionPoint = (corners, point) => {
  for (let index = 1; index <= corners.length; index++) {
    let start = corners[index - 1];
    let end = index === corners.length ? corners[0] : corners[index];
...
var CloudEngine = {
  draw(board, rectangle, options) {
    ...
    const pathData = `M ${startPoint[0]} ${startPoint[1]} ` + arcCommands.map((command) => `A ${command.rx} ${command.ry} ${command.xAxisRotation} ${command.largeArcFlag} ${command.sweepFlag} ${command.endX} ${command.endY}`).join("\n") + " Z";
...
var isTextExceedingBounds = (geometry) => {
...
var isRectangleHitElementText = (element, rectangle) => {
  const engine = getEngine(element.shape);
...
var isHitElementText = (element, point) => {
  const engine = getEngine(element.shape);
  if (isMultipleTextGeometry(element)) {
    const texts = element.texts;
    return texts.some((item) => {
...
var isEmptyTextElement = (element) => {
...
var isRectangleHitDrawElement = (board, element, selection) => {
...
var getFirstFilledDrawElement = (board, elements) => {
...
var isFilledDrawElement = (board, element) => {
  return getFirstFilledDrawElement(board, [element]) !== null;
};
var getSolidElements = (elements) => {
...
var debugKey$3 = "debug:plait:hit:shape:edge:sample-points";
var debugGenerator$3 = createDebugGenerator(debugKey$3);
var shapes = [BasicShapes.cloud];
var isHitDrawElement = (board, element, point, isStrict = true) => {
...
var isHitEdgeOfShape = (board, element, point, hitDistanceBuffer) => {
...
var isInsideOfShape = (board, element, point, hitDistanceBuffer) => {
...
var isHitElementInside = (board, element, point) => {
  const rectangle = board.getRectangle(element);
  point = rotateAntiPointsByElement(board, point, element) || point;
...
var getStrokeWidthByElement = (element) => {
  if (PlaitDrawElement.isText(element)) {
    return 0;
  }
...
var insertElement = (board, element) => {
...
var isDrawElementIncludeText = (element) => {
  if (PlaitDrawElement.isText(element)) {
    return true;
  }
  if (PlaitDrawElement.isImage(element)) {
...
var isDrawElementsIncludeText = (elements) => {
  return elements.some((item) => {
    return isDrawElementIncludeText(item);
  });
};
var isClosedDrawElement = (element) => {
...
var getSnappingRef = (board, hitElement, point) => {
...
var getHitShape = (board, point, offset = LINE_HIT_GEOMETRY_BUFFER) => {
  let hitShape = null;
...
var traverseDrawShapes = (board, callback) => {
...
var drawShape = (board, outerRectangle, shape, roughOptions, drawOptions) => {
  return getEngine(shape).draw(board, outerRectangle, roughOptions, drawOptions);
};
var drawBoundReaction = (board, element, roughOptions = { hasMask: true, hasConnector: true }) => {
  const g = createG();
...
var getGeometryAlign = (board, element) => {
  var _a, _b;
  if (isMultipleTextGeometry(element)) {
    const drawShapeText = element.texts.find((item) => item.id.includes(GeometryCommonTextKeys.content));
    return (drawShapeText == null ? void 0 : drawShapeText.text.align) || Alignment.center;
  }
  if (isSingleTextGeometry(element)) {
    return ((_a = element.text) == null ? void 0 : _a.align) || Alignment.center;
  }
  if (PlaitDrawElement.isElementByTable(element)) {
    const firstTextCell = element.cells.find((item) => item.text);
    return ((_b = firstTextCell == null ? void 0 : firstTextCell.text) == null ? void 0 : _b.align) || Alignment.center;
  }
  return Alignment.center;
};
var isClosedPoints = (points) => {
  const startPoint = points[0];
  const endPoint = points[points.length - 1];
  return startPoint[0] === endPoint[0] && startPoint[1] === endPoint[1];
};
var getDefaultGeometryText = (board) => {
...
var getFillByElement = (board, element) => {
  const defaultFill = PlaitDrawElement.isFlowchart(element) && isClosedDrawElement(element) ? getFlowchartDefaultFill(board.theme.themeColorMode) : DefaultDrawStyle.fill;
...
var GeometryShapeGenerator = class extends Generator {
...
function getMiddlePoints(board, element) {
  ...
  if (shape === ArrowLineShape.straight) {
    const points = PlaitDrawElement.isArrowLine(element) ? PlaitArrowLine.getPoints(board, element) : element.points;
  ...
  if (shape === ArrowLineShape.curve) {
    const points = PlaitDrawElement.isArrowLine(element) ? PlaitArrowLine.getPoints(board, element) : element.points;
    const pointsOnBezier = PlaitDrawElement.isArrowLine(element) ? getCurvePoints(board, element) : getVectorLinePoints(board, element);
    if (points.length === 2) {
      const start = 0;
  ...
  if (shape === ArrowLineShape.elbow) {
    ...
    if (!isUseDefaultOrthogonalRoute(element, options)) {
      ...
      for (let i = 0; i < renderPoints.length - 1; i++) {
        if (i == 0 && Point.isEquals(renderPoints[i + 1], nextSourcePoint) || i === renderPoints.length - 2 && Point.isEquals(renderPoints[renderPoints.length - 2], nextTargetPoint)) {
          continue;
        }
...
(function(LineResizeHandle2) {
  LineResizeHandle2["source"] = "source";
  LineResizeHandle2["target"] = "target";
  LineResizeHandle2["addHandle"] = "addHandle";
})(LineResizeHandle || (LineResizeHandle = {}));
var getHitLineResizeHandleRef = (board, element, point) => {
...
function getHitPointIndex(points, movingPoint) {
  ...
  const rectangle = rectangles.find((rectangle2) => {
    return RectangleClient.isHit(RectangleClient.getRectangleByPoints([movingPoint, movingPoint]), rectangle2);
  });
  return rectangle ? rectangles.indexOf(rectangle) : -1;
}
var LineActiveGenerator = class extends Generator {
...
var _ArrowLineAutoCompleteGenerator = class _ArrowLineAutoCompleteGenerator extends Generator {
  constructor(board) {
...
_ArrowLineAutoCompleteGenerator.key = "line-auto-complete-generator";
var ArrowLineAutoCompleteGenerator = _ArrowLineAutoCompleteGenerator;
var SingleTextGenerator = class extends TextGenerator {
  get textManage() {
    return this.textManages[0];
  }
  constructor(board, element, text, options) {
    super(board, element, [{ id: element.id, text, textHeight: element.textHeight }], options);
  }
...
var TableGenerator = class extends Generator {
  canDraw(element, data) {
    return true;
  }
  draw(element, data) {
...
var getGeometryGeneratorByShape = (board, shape) => {
...
var createUMLClassOrInterfaceGeometryElement = (board, shape, points) => {
  const memorizedLatest = getMemorizedLatestByPointer(shape);
  const element = {
    id: idCreator(),
    type: "geometry",
...
var buildTableCellsForGeometry = (board, rows, columns, shape) => {
  var _a;
  const memorizedLatest = getMemorizedLatestByPointer(shape);
  const cellCount = rows.length * columns.length;
  const defaultTexts = ((_a = getDefaultGeometryProperty(shape)) == null ? void 0 : _a.texts) || [];
  const textHeights = defaultTexts.map((textItem) => {
    return getTextShapeProperty(board, textItem.text || getDefaultGeometryText(board), memorizedLatest.textProperties["font-size"]).height;
  });
...
var createGeometryElement = (shape, points, text, options = {}, textProperties = {}) => {
...
var createGeometryElementWithText = (shape, points, text, options = {}, textProperties = {}) => {
  let textOptions = {};
  ...
  (textProperties == null ? void 0 : textProperties.align) && (alignment = textProperties == null ? void 0 : textProperties.align);
  (textProperties == null ? void 0 : textProperties.textHeight) && (textHeight = textProperties == null ? void 0 : textProperties.textHeight);
  textProperties == null ? true : delete textProperties.align;
  textProperties == null ? true : delete textProperties.textHeight;
  return {
    id: idCreator(),
...
var createGeometryElementWithoutText = (shape, points, options = {}) => {
  return {
    id: idCreator(),
    type: "geometry",
    shape,
...
var drawGeometry = (board, outerRectangle, shape, roughOptions) => {
  return getEngine(shape).draw(board, outerRectangle, roughOptions);
};
var getNearestPoint = (element, point) => {
  const rectangle = RectangleClient.getRectangleByPoints(element.points);
  const shape = getElementShape(element);
  return getEngine(shape).getNearestPoint(rectangle, point);
};
var getCenterPointsOnPolygon = (points) => {
  const centerPoint = [];
  for (let i = 0; i < points.length; i++) {
    let j = i == points.length - 1 ? 0 : i + 1;
...
var getDefaultFlowchartProperty = (symbol) => {
  return DefaultFlowchartPropertyMap[symbol];
};
var getDefaultBasicShapeProperty = (shape) => {
  return DefaultBasicShapePropertyMap[shape] || DefaultBasicShapeProperty;
};
var getDefaultUMLProperty = (shape) => {
  return DefaultUMLPropertyMap[shape];
};
var getAutoCompletePoints = (board, element, isToActive = false) => {
...
var getHitIndexOfAutoCompletePoint = (movingPoint, points) => {
...
var getDrawDefaultStrokeColor = (theme) => {
  return DrawThemeColors[theme].strokeColor;
};
var getFlowchartDefaultFill = (theme) => {
  return DrawThemeColors[theme].fill;
};
var getTextShapeProperty = (board, text, fontSize) => {
...
var getDefaultGeometryPoints = (pointer, centerPoint) => {
...
var getDefaultGeometryProperty = (pointer) => {
...
var getDefaultTextPoints = (board, centerPoint, fontSize) => {
  const property = getTextShapeProperty(board, DefaultTextProperty.text, fontSize);
  return RectangleClient.getPoints(RectangleClient.getRectangleByCenterPoint(centerPoint, property.width, property.height));
};
var createTextElement = (board, points, text, textHeight) => {
...
var createDefaultGeometry = (board, points, shape) => {
  const memorizedLatest = getMemorizedLatestByPointer(shape);
...
var editText = (board, element, text) => {
...
var getNextSourceAndTargetPoints = (board, element) => {
  const options = getElbowLineRouteOptions(board, element);
  return [options.nextSourcePoint, options.nextTargetPoint];
};
var getSourceAndTargetRectangle = (board, element, handleRefPair) => {
  let sourceElement = element.source.boundId ? getElementById(board, element.source.boundId) : void 0;
  let targetElement = element.target.boundId ? getElementById(board, element.target.boundId) : void 0;
  if (!sourceElement) {
  ...
  const rotatedSourceCornerPoints = rotatePointsByElement(RectangleClient.getCornerPoints(sourceRectangle), sourceElement) || RectangleClient.getCornerPoints(sourceRectangle);
  ...
  const rotatedTargetCornerPoints = rotatePointsByElement(RectangleClient.getCornerPoints(targetRectangle), targetElement) || RectangleClient.getCornerPoints(targetRectangle);
...
var createFakeElement = (startPoint, vector) => {
...
var resizeGeometry = (board, points, textHeight, path) => {
  const normalizePoints2 = normalizeShapePoints(points);
  const element = PlaitNode.get(board, path);
  const newProperties = { points: normalizePoints2, textHeight };
  if (PlaitDrawElement.isText(element) && element.autoSize) {
    newProperties.autoSize = false;
  }
  Transforms.setNode(board, newProperties, path);
};
var switchGeometryShape = (board, shape) => {
  const selectedElements = getSelectedElements(board);
  const refs = [];
...
var normalizePoints = (board, element, width, textHeight) => {
...
var setText = (board, element, text, width, textHeight) => {
  const newElement = {
    text,
    textHeight,
...
var setTextSize = (board, element, textWidth, textHeight) => {
  if (element.autoSize) {
    const newElement = {
      textHeight,
...
var insertImage = (board, imageItem, startPoint) => {
  ...
  const points = startPoint ? [startPoint, [startPoint[0] + width, startPoint[1] + height]] : [
...
var resizeArrowLine = (board, options, path) => {
  Transforms.setNode(board, options, path);
};
var setArrowLineTexts = (board, element, texts) => {
  const path = PlaitBoard.findPath(board, element);
  Transforms.setNode(board, { texts }, path);
};
var removeArrowLineText = (board, element, index) => {
  var _a;
  const path = PlaitBoard.findPath(board, element);
  const texts = ((_a = element.texts) == null ? void 0 : _a.length) ? [...element.texts] : [];
  const newTexts = [...texts];
  newTexts.splice(index, 1);
  Transforms.setNode(board, { texts: newTexts }, path);
};
var setArrowLineMark = (board, handleKey, marker) => {
...
var setArrowLineShape = (board, newProperties) => {
...
var connectArrowLineToDraw = (board, lineElement, handle, geometryElement) => {
...
var getDefaultSwimlanePoints = (pointer, centerPoint) => {
  const property = DefaultSwimlanePropertyMap[pointer];
  return RectangleClient.getPoints(RectangleClient.getRectangleByCenterPoint(centerPoint, property.width, property.height));
};
var createDefaultSwimlane = (shape, points) => {
...
var createDefaultRowsOrColumns = (shape, type, header, size) => {
  const createItems = (count) => new Array(count).fill("").map(() => ({ id: idCreator() }));
  let data = createItems(3);
  if (type === "row" && shape === SwimlaneSymbols.swimlaneVertical || type === "column" && shape === SwimlaneSymbols.swimlaneHorizontal) {
...
var createDefaultCells = (shape, rows, columns, header) => {
  let headerCell = [];
  let startIndex = 0;
  if (header) {
  ...
  const cells = new Array(6).fill("").map((_, index) => {
    if (index < 3) {
      const rowId2 = shape === SwimlaneSymbols.swimlaneVertical ? rows[startIndex].id : rows[index].id;
      const columnId2 = shape === SwimlaneSymbols.swimlaneVertical ? columns[index].id : columns[startIndex].id;
      return createCell(rowId2, columnId2, header ? "Lane" : "New Swimlane");
    }
...
var isSwimlaneWithHeader = (shape) => {
  return [SwimlaneDrawSymbols.swimlaneHorizontalWithHeader, SwimlaneDrawSymbols.swimlaneVerticalWithHeader].includes(shape);
};
var isSwimlaneShape = (shape) => {
  return getSwimlaneShapes().includes(shape);
};
var adjustSwimlaneShape = (shape) => {
  return [SwimlaneDrawSymbols.swimlaneHorizontalWithHeader, SwimlaneDrawSymbols.swimlaneHorizontal].includes(shape) ? SwimlaneSymbols.swimlaneHorizontal : SwimlaneSymbols.swimlaneVertical;
};
var isSwimlanePointers = (board, pointer = board.pointer) => {
  return getSwimlanePointers().includes(pointer);
};
var updateSwimlaneCount = (board, swimlane, count) => {
...
var addSwimlaneRow = (board, swimlane, index, count = 1) => {
  if (PlaitDrawElement.isHorizontalSwimlane(swimlane)) {
...
var addSwimlaneColumn = (board, swimlane, index, count = 1) => {
  if (PlaitDrawElement.isVerticalSwimlane(swimlane)) {
...
var removeSwimlaneRow = (board, swimlane, index, count = 1) => {
  if (PlaitDrawElement.isHorizontalSwimlane(swimlane)) {
...
var removeSwimlaneColumn = (board, swimlane, index, count = 1) => {
  if (PlaitDrawElement.isVerticalSwimlane(swimlane)) {
...
var createNewSwimlaneCells = (swimlane, newId, type) => {
  ...
  cells[0] = {
    ...
    text: {
      ...
      align: Alignment.center,
      direction: type === "row" ? void 0 : "vertical"
    },
    textHeight: 20
  };
  return cells;
};
var updateSwimlane = (board, swimlane, newColumns, newRows, newCells, newPoints) => {
  const path = PlaitBoard.findPath(board, swimlane);
...
var setDrawTexts = (board, element, text) => {
  var _a;
  const newTexts = (_a = element.texts) == null ? void 0 : _a.map((item) => {
    if (item.id === text.id) {
      return { ...item, ...text };
    }
    return item;
...
var setTableText = (board, path, cellId, text, textHeight) => {
...
var setTableFill = (board, element, fill, path) => {
  const selectedCells = getSelectedCells(element);
  let newCells = element.cells;
  if (selectedCells == null ? void 0 : selectedCells.length) {
...
var setVectorLineShape = (board, newProperties) => {
...
var insertDrawByVector = (board, point, shape, vector) => {
  const swimlanePointers = getSwimlanePointers();
  const isSwimlanePointer = swimlanePointers.includes(shape);
  let shapeProperty = DefaultFlowchartPropertyMap[shape] || DefaultBasicShapePropertyMap[shape] || DefaultUMLPropertyMap[shape] || DefaultBasicShapeProperty;
...
var getHitRectangleResizeHandleRef = (board, rectangle, point, angle = 0) => {
...
var getRotateHandleRectangle = (rectangle) => {
  return {
...
var debugKey$2 = "debug:plait:resize-for-rotation";
var debugGenerator$2 = createDebugGenerator(debugKey$2);
function withDrawResize(board) {
  ...
  const canResize = () => {
    ...
    return elements.length >= 1 && elements.every((el) => (PlaitDrawElement.isDrawElement(el) || PlaitDrawElement.isCustomGeometryElement(board, el) && el.points.length > 1) && !isSingleSelectLine(board) && !isSingleSelectSwimlane(board));
  };
  const options = {
    key: "draw-elements",
    canResize,
    ...
    onResize: (resizeRef, resizeState) => {
      ...
      resizeRef.element.forEach((target) => {
        ...
        if (PlaitDrawElement.isGeometry(target)) {
        ...
        } else if (PlaitDrawElement.isLine(target) || PlaitDrawElement.isCustomGeometryElement(board, target) || PlaitDrawElement.isVectorLine(target)) {
          Transforms.setNode(board, { points }, path);
          ...
          if (isAspectRatio) {
            ...
            const centerPoint2 = RectangleClient.getCenterPoint(targetRectangle);
            const newCenterPoint = movePointByZoomAndOriginPoint(centerPoint2, originPoint, resizeSnapRef.xZoom, resizeSnapRef.yZoom);
...
var getResizeOriginPointAndHandlePoint = (board, handleIndex, rectangle) => {
...
var getResizeZoom = (resizeStartAndEnd, resizeOriginPoint, resizeHandlePoint, isFromCorner, isAspectRatio) => {
...
var movePointByZoomAndOriginPoint = (p, resizeOriginPoint, xZoom, yZoom) => {
  const offsetX = (p[0] - resizeOriginPoint[0]) * xZoom;
  const offsetY = (p[1] - resizeOriginPoint[1]) * yZoom;
  return [p[0] + offsetX, p[1] + offsetY];
};
var getResizePointsByOtherwiseAxis = (board, points, resizeOriginPoint, xZoom, yZoom) => {
...
var generatorResizeHandles = (board, resizeActivePoints, needCustomActiveRectangle) => {
  const handleG = createG();
  const elements = getSelectedElements(board);
  const boundingRectangle = needCustomActiveRectangle ? RectangleClient.getRectangleByPoints(resizeActivePoints) : getRectangleByElements(board, elements, false);
...
var debugKey$1 = "debug:plait:point-for-geometry";
var debugGenerator$1 = createDebugGenerator(debugKey$1);
var EQUAL_SPACING = 10;
function getSnapResizingRefOptions(board, resizeRef, resizeState, resizeOriginPointAndHandlePoint, isAspectRatio, isFromCorner) {
  ...
  if (Array.isArray(resizeRef.element)) {
    ...
    const rectangle2 = getRectangleByElements(board, resizeRef.element, false);
    resizeOriginPoint = RectangleClient.getPoints(rectangle2);
  } else {
    activeElements = [resizeRef.element];
...
var buildClipboardData2 = (board, elements, startPoint) => {
  return buildClipboardData(board, elements, startPoint, (element) => {
    if (PlaitDrawElement.isArrowLine(element)) {
...
var insertClipboardData2 = (board, elements, startPoint) => {
  insertClipboardData(board, elements, startPoint, (element, idsMap) => {
    if (PlaitDrawElement.isArrowLine(element)) {
      if (element.source.boundId) {
...
var getCommentPoints = (rectangle) => {
  return [
...
function createPolygonEngine(options) {
  const getPoints2 = options.getPolygonPoints;
  const engine = {
    draw(board, rectangle, options2) {
      const points = getPoints2(rectangle);
      const rs = PlaitBoard.getRoughSVG(board);
      const polygon = rs.polygon(points, { ...options2, fillStyle: "solid" });
      setStrokeLinecap(polygon, "round");
      return polygon;
    },
    isInsidePoint(rectangle, point) {
    ...
    getCornerPoints(rectangle) {
      return getPoints2(rectangle);
    },
    getNearestPoint(rectangle, point) {
      return getNearestPointBetweenPointAndSegments(point, getPoints2(rectangle));
    },
    getNearestCrossingPoint(rectangle, point) {
      const corners = getPoints2(rectangle);
      ...
      crossingPoints.filter((v, index) => index > 0).forEach((crossingPoint) => {
...
var CrossEngine = createPolygonEngine({
...
var DiamondEngine = createPolygonEngine({
...
function createEllipseEngine(createOptions) {
  ...
  if (createOptions == null ? void 0 : createOptions.draw) {
    engine.draw = createOptions.draw;
  }
  if (createOptions == null ? void 0 : createOptions.getTextRectangle) {
    engine.getTextRectangle = createOptions.getTextRectangle;
  }
  return engine;
}
var EllipseEngine = createEllipseEngine();
var getHexagonPoints = (rectangle) => {
  return [
    [rectangle.x + rectangle.width / 4, rectangle.y],
    [rectangle.x + rectangle.width * 3 / 4, rectangle.y],
...
var HexagonEngine = createPolygonEngine({
...
var getLeftArrowPoints = (rectangle) => {
  return [
    [rectangle.x, rectangle.y + rectangle.height / 2],
...
var LeftArrowEngine = createPolygonEngine({
...
var getOctagonPoints = (rectangle) => {
  return [
...
var OctagonEngine = createPolygonEngine({
...
var getParallelogramPoints = (rectangle) => {
  return [
    [rectangle.x + rectangle.width / 4, rectangle.y],
    [rectangle.x + rectangle.width, rectangle.y],
    [rectangle.x + rectangle.width * 3 / 4, rectangle.y + rectangle.height],
...
var ParallelogramEngine = createPolygonEngine({
...
var getPentagonPoints = (rectangle) => {
  return [
...
var PentagonEngine = createPolygonEngine({
...
var getPentagonArrowPoints = (rectangle) => {
...
var PentagonArrowEngine = createPolygonEngine({
...
var getProcessArrowPoints = (rectangle) => {
  const wider = rectangle.width > rectangle.height / 2;
  return [
    [rectangle.x, rectangle.y],
    [rectangle.x + (wider ? rectangle.width - rectangle.height / 2 : 0), rectangle.y],
...
var ProcessArrowEngine = createPolygonEngine({
...
var getRightArrowPoints = (rectangle) => {
  return [
...
var RightArrowEngine = createPolygonEngine({
...
var getRoundRectangleRadius = (rectangle) => {
...
function getNearestPointBetweenPointAndRoundRectangle$1(point, rectangle, radius) {
  ...
  const inRightBottom = point[0] >= rectX + width - radius && point[0] <= rectX + width && point[1] >= rectY + height - radius && point[1] <= rectY + height;
  if (inRightBottom) {
...
var getRoundCommentPoints = (rectangle) => {
  return [
    [rectangle.x, rectangle.y],
    [rectangle.x + rectangle.width, rectangle.y],
...
var getTrapezoidPoints = (rectangle) => {
  return [
...
var TrapezoidEngine = createPolygonEngine({
...
var getTrianglePoints = (rectangle) => {
  return [
    [rectangle.x + rectangle.width / 2, rectangle.y],
    [rectangle.x + rectangle.width, rectangle.y + rectangle.height],
    [rectangle.x, rectangle.y + rectangle.height]
...
var TriangleEngine = createPolygonEngine({
...
var getTwoWayArrowPoints = (rectangle) => {
  return [
    [rectangle.x, rectangle.y + rectangle.height / 2],
...
var TwoWayArrowEngine = createPolygonEngine({
...
var StarEngine = createPolygonEngine({
...
var getStartEndRadius = (rectangle) => {
...
var getManualInputPoints = (rectangle) => {
  return [
    [rectangle.x, rectangle.y + rectangle.height / 4],
    [rectangle.x + rectangle.width, rectangle.y],
    [rectangle.x + rectangle.width, rectangle.y + rectangle.height],
...
var ManualInputEngine = createPolygonEngine({
...
var getPreparationPoints = (rectangle) => {
  return [
    [rectangle.x, rectangle.y + rectangle.height / 2],
...
var PreparationEngine = createPolygonEngine({
...
var getManualLoopPoints = (rectangle) => {
  return [
    [rectangle.x, rectangle.y],
    [rectangle.x + rectangle.width, rectangle.y],
...
var ManualLoopEngine = createPolygonEngine({
...
var MergeEngine = createPolygonEngine({
...
var DelayEngine = {
  draw(board, rectangle, options) {
    const rs = PlaitBoard.getRoughSVG(board);
    const shape = rs.path(`M${rectangle.x} ${rectangle.y} L${rectangle.x + rectangle.width * 3 / 4} ${rectangle.y} A  ${rectangle.width / 4} ${rectangle.height / 2}, 0, 0, 1,${rectangle.x + rectangle.width * 3 / 4} ${rectangle.y + rectangle.height} L${rectangle.x} ${rectangle.y + rectangle.height} Z`, { ...options, fillStyle: "solid" });
    setStrokeLinecap(shape, "round");
    return shape;
  },
  isInsidePoint(rectangle, point) {
...
var StoredDataEngine = {
  ...
  getNearestPoint(rectangle, point) {
    ...
    if (nearestPoint[0] < rectangle.x + rectangle.width / 10) {
      ...
      const nearestPoint2 = getNearestPointBetweenPointAndEllipse(point, centerPoint, rectangle.width / 10, rectangle.height / 2);
      if (nearestPoint2[0] > centerPoint[0]) {
        nearestPoint2[0] = centerPoint[0] * 2 - nearestPoint2[0];
      }
...
var PredefinedProcessEngine = {
  draw(board, rectangle, options) {
    const rs = PlaitBoard.getRoughSVG(board);
    const shape = rs.path(`M${rectangle.x} ${rectangle.y} H${rectangle.x + rectangle.width} V${rectangle.y + rectangle.height} H${rectangle.x} Z M${rectangle.x + rectangle.width * 0.06} ${rectangle.y} L${rectangle.x + rectangle.width * 0.06} ${rectangle.y + rectangle.height} M${rectangle.x + rectangle.width - rectangle.width * 0.06} ${rectangle.y} L${rectangle.x + rectangle.width - rectangle.width * 0.06} ${rectangle.y + rectangle.height}`, { ...options, fillStyle: "solid" });
    setStrokeLinecap(shape, "round");
    return shape;
  },
  isInsidePoint(rectangle, point) {
...
var getOffPagePoints = (rectangle) => {
  return [
    [rectangle.x, rectangle.y],
    [rectangle.x + rectangle.width, rectangle.y],
    [rectangle.x + rectangle.width, rectangle.y + rectangle.height / 2],
...
var OffPageEngine = createPolygonEngine({
...
var OrEngine = createEllipseEngine({
  draw(board, rectangle, options) {
    const rs = PlaitBoard.getRoughSVG(board);
...
var SummingJunctionEngine = createEllipseEngine({
  draw(board, rectangle, options) {
    const rs = PlaitBoard.getRoughSVG(board);
    const rx = rectangle.width / 2;
    const ry = rectangle.height / 2;
...
var DocumentEngine = {
  draw(board, rectangle, options) {
    const rs = PlaitBoard.getRoughSVG(board);
    const shape = rs.path(`M${rectangle.x} ${rectangle.y + rectangle.height - rectangle.height / 9} V${rectangle.y} H${rectangle.x + rectangle.width} V${rectangle.y + rectangle.height - rectangle.height / 9}
            Q${rectangle.x + rectangle.width - rectangle.width / 4} ${rectangle.y + rectangle.height - rectangle.height / 9 * 3}, ${rectangle.x + rectangle.width / 2} ${rectangle.y + rectangle.height - rectangle.height / 9} T${rectangle.x} ${rectangle.y + rectangle.height - rectangle.height / 9}           
            `, { ...options, fillStyle: "solid" });
    setStrokeLinecap(shape, "round");
    return shape;
  },
...
var getMultiDocumentPoints = (rectangle) => {
  const linePoints = [
...
var MultiDocumentEngine = {
  ...
  getTangentVectorByConnectionPoint(rectangle, pointOfRectangle) {
    ...
    if (connectionPoint[0] > rectangle.x + (rectangle.width - 10) / 4 && connectionPoint[0] < rectangle.x + (rectangle.width - 10) / 4 * 3) {
    ...
    if (connectionPoint[0] > rectangle.x + (rectangle.width - 10) / 4 * 3 && connectionPoint[0] < rectangle.x + rectangle.width - 10) {
...
var DatabaseEngine = {
  ...
  getNearestPoint(rectangle, point) {
    ...
    if (nearestPoint[1] < rectangle.y + rectangle.height * 0.15) {
      ...
      const nearestPoint2 = getNearestPointBetweenPointAndEllipse(point, centerPoint, rectangle.width / 2, rectangle.height * 0.15);
      if (nearestPoint2[1] > centerPoint[1]) {
        nearestPoint2[1] = centerPoint[1] * 2 - nearestPoint2[1];
      }
      return nearestPoint2;
    }
    if (nearestPoint[1] > rectangle.y + rectangle.height - rectangle.height * 0.15) {
      ...
      const nearestPoint2 = getNearestPointBetweenPointAndEllipse(point, centerPoint, rectangle.width / 2, rectangle.height * 0.15);
      if (nearestPoint2[1] < centerPoint[1]) {
        nearestPoint2[1] = centerPoint[0] * 2 - nearestPoint2[1];
      }
      return nearestPoint2;
    }
    return nearestPoint;
...
var HardDiskEngine = {
  draw(board, rectangle, options) {
    ...
    const shape = rs.path(`M${rectangle.x + rectangle.width - rectangle.width * 0.15} ${rectangle.y}  
            A${rectangle.width * 0.15} ${rectangle.height / 2}, 0, 0, 0,${rectangle.x + rectangle.width - rectangle.width * 0.15} ${rectangle.y + rectangle.height} 
            ...
            A${rectangle.width * 0.15} ${rectangle.height / 2}, 0, 0, 0, ${rectangle.x + rectangle.width * 0.15} ${rectangle.y + rectangle.height}
  ...
  getNearestPoint(rectangle, point) {
    ...
    if (nearestPoint[0] < rectangle.x + rectangle.width * 0.15) {
      ...
      const nearestPoint2 = getNearestPointBetweenPointAndEllipse(point, centerPoint, rectangle.width * 0.15, rectangle.height / 2);
      if (nearestPoint2[0] > centerPoint[0]) {
        nearestPoint2[0] = centerPoint[0] * 2 - nearestPoint2[0];
      }
      return nearestPoint2;
...
var NoteCurlyLeftEngine = {
  ...
  getNearestPoint(rectangle, point) {
    const { startPoint, upperCurve, lowerCurve } = generateNoteCurlyLeftPath(rectangle);
    const upperBezierPoints = pointsOnBezierCurves([startPoint, upperCurve.controlPoint1, upperCurve.controlPoint2, upperCurve.endPoint], 1e-3);
    const lowerBezierPoints = pointsOnBezierCurves([upperCurve.endPoint, lowerCurve.controlPoint1, lowerCurve.controlPoint2, lowerCurve.endPoint], 1e-3);
...
var NoteSquareEngine = {
  draw(board, rectangle, options) {
    const rs = PlaitBoard.getRoughSVG(board);
    const shape = rs.path(`M${rectangle.x + rectangle.width * 0.075} ${rectangle.y + rectangle.height} H${rectangle.x} V${rectangle.y} H${rectangle.x + rectangle.width * 0.075}
...
var getDisplayPoints = (rectangle) => {
  return [
    [rectangle.x, rectangle.y + rectangle.height / 2],
    [rectangle.x + rectangle.width * 0.15, rectangle.y],
    [rectangle.x + rectangle.width, rectangle.y],
...
var DisplayEngine = {
  draw(board, rectangle, options) {
    ...
    const shape = rs.path(`M${rectangle.x + rectangle.width * 0.15} ${rectangle.y} 
            ...
            A ${rectangle.width * 0.1} ${rectangle.height / 2}, 0, 0, 1,${rectangle.x + rectangle.width - rectangle.width * 0.1} ${rectangle.y + rectangle.height}
            H${rectangle.x + rectangle.width * 0.15}
...
var TableEngine = {
  draw(board, rectangle, roughOptions, options) {
    const g = createG();
    try {
      const pointCells = getCellsWithPoints(board, { ...options == null ? void 0 : options.element });
      if (pointCells) {
        const rs = PlaitBoard.getRoughSVG(board);
        const { x, y, width, height } = rectangle;
        ...
        pointCells.forEach((cell) => {
          const rectangle2 = RectangleClient.getRectangleByPoints(cell.points);
          const { x: x2, y: y2, width: width2, height: height2 } = rectangle2;
          const cellRectangle = drawRectangle(board, {
            x: x2 + ACTIVE_STROKE_WIDTH,
            y: y2 + ACTIVE_STROKE_WIDTH,
            width: width2 - ACTIVE_STROKE_WIDTH * 2,
            height: height2 - ACTIVE_STROKE_WIDTH * 2
          }, { fill: cell.fill, fillStyle: "solid", strokeWidth: 0 });
          const cellRightBorder = drawLine(rs, [x2 + width2, y2], [x2 + width2, y2 + height2], roughOptions);
          const cellBottomBorder = drawLine(rs, [x2, y2 + height2], [x2 + width2, y2 + height2], roughOptions);
  ...
  getTextRectangle(element, options) {
    try {
      if (options && options.id) {
        const cell = getCellWithPoints(options == null ? void 0 : options.board, element, options.id);
        if (cell) {
          if (PlaitTableElement.isVerticalText(cell)) {
...
var PackageEngine = {
  ...
  getTextRectangle(element, options) {
    ...
    const elementRectangle = RectangleClient.getRectangleByPoints(element.points);
    const strokeWidth = getStrokeWidthByElement(element);
    const textHeight = (_b = (_a = element.texts) == null ? void 0 : _a.find((item) => item.id === (options == null ? void 0 : options.id))) == null ? void 0 : _b.textHeight;
    if ((options == null ? void 0 : options.id) === GeometryCommonTextKeys.name) {
    ...
    if ((options == null ? void 0 : options.id) === GeometryCommonTextKeys.content) {
      const width = elementRectangle.width - ShapeDefaultSpace.rectangleAndText * 2 - strokeWidth * 2;
      return {
        height: textHeight,
        width: width > 0 ? width : 0,
...
var ActiveClassEngine = {
  draw(board, rectangle, options) {
    const rs = PlaitBoard.getRoughSVG(board);
    const shape = rs.path(`M${rectangle.x} ${rectangle.y} H${rectangle.x + rectangle.width} V${rectangle.y + rectangle.height} H${rectangle.x} Z M${rectangle.x + rectangle.width * 0.125} ${rectangle.y} L${rectangle.x + rectangle.width * 0.125} ${rectangle.y + rectangle.height} M${rectangle.x + rectangle.width - rectangle.width * 0.125} ${rectangle.y} L${rectangle.x + rectangle.width - rectangle.width * 0.125} ${rectangle.y + rectangle.height}`, { ...options, fillStyle: "solid" });
    setStrokeLinecap(shape, "round");
    return shape;
  },
  isInsidePoint(rectangle, point) {
...
var getArrowLineHandleRefPair = (board, element) => {
  const strokeWidth = getStrokeWidthByElement(element);
  const sourceBoundElement = element.source.boundId ? getElementById(board, element.source.boundId) : void 0;
  const targetBoundElement = element.target.boundId ? getElementById(board, element.target.boundId) : void 0;
  let sourcePoint = sourceBoundElement ? getConnectionPoint(sourceBoundElement, element.source.connection) : element.points[0];
  let targetPoint = targetBoundElement ? getConnectionPoint(targetBoundElement, element.target.connection) : element.points[element.points.length - 1];
  ...
  if (sourceBoundElement) {
    const connectionOffset = PlaitArrowLine.isSourceMarkOrTargetMark(element, ArrowLineMarkerType.none, ArrowLineHandleKey.source) ? 0 : strokeWidth;
  ...
  if (targetBoundElement) {
    const connectionOffset = PlaitArrowLine.isSourceMarkOrTargetMark(element, ArrowLineMarkerType.none, ArrowLineHandleKey.target) ? 0 : strokeWidth;
...
var getConnectionPoint = (geometry, connection, direction, delta) => {
...
var getVectorByConnection = (boundElement, connection) => {
...
var getElbowLineRouteOptions = (board, element, handleRefPair) => {
...
var collectArrowLineUpdatedRefsByGeometry = (board, element, refs) => {
  const lines = findElements(board, {
    match: (element2) => {
      if (PlaitDrawElement.isArrowLine(element2)) {
        return element2.source.boundId === element2.id || element2.target.boundId === element2.id;
      }
      return false;
    },
    recursion: (element2) => true
  });
  if (lines.length) {
    lines.forEach((line) => {
...
(function(ArrowLineMarkerType2) {
  ArrowLineMarkerType2["arrow"] = "arrow";
  ArrowLineMarkerType2["none"] = "none";
  ArrowLineMarkerType2["openTriangle"] = "open-triangle";
  ArrowLineMarkerType2["solidTriangle"] = "solid-triangle";
  ArrowLineMarkerType2["sharpArrow"] = "sharp-arrow";
  ArrowLineMarkerType2["oneSideUp"] = "one-side-up";
  ArrowLineMarkerType2["oneSideDown"] = "one-side-down";
  ArrowLineMarkerType2["hollowTriangle"] = "hollow-triangle";
  ArrowLineMarkerType2["singleSlash"] = "single-slash";
})(ArrowLineMarkerType || (ArrowLineMarkerType = {}));
var ArrowLineShape;
(function(ArrowLineShape2) {
  ArrowLineShape2["straight"] = "straight";
  ArrowLineShape2["curve"] = "curve";
  ArrowLineShape2["elbow"] = "elbow";
})(ArrowLineShape || (ArrowLineShape = {}));
var ArrowLineHandleKey;
(function(ArrowLineHandleKey2) {
  ArrowLineHandleKey2["source"] = "source";
  ArrowLineHandleKey2["target"] = "target";
...
var MemorizeKey;
(function(MemorizeKey2) {
  MemorizeKey2["basicShape"] = "basicShape";
  MemorizeKey2["flowchart"] = "flowchart";
  MemorizeKey2["text"] = "text";
  MemorizeKey2["arrowLine"] = "arrow-line";
  MemorizeKey2["UML"] = "UML";
})(MemorizeKey || (MemorizeKey = {}));
var VectorLinePointerType;
(function(VectorLinePointerType2) {
  VectorLinePointerType2["vectorLine"] = "vectorLine";
})(VectorLinePointerType || (VectorLinePointerType = {}));
var VectorLineShape;
(function(VectorLineShape2) {
  VectorLineShape2["straight"] = "straight";
  VectorLineShape2["curve"] = "curve";
})(VectorLineShape || (VectorLineShape = {}));
var PlaitDrawElement = {
  isGeometry: (value) => {
  ...
  isDrawElement: (value) => {
    if (PlaitDrawElement.isGeometry(value) || PlaitDrawElement.isLine(value) || PlaitDrawElement.isImage(value) || PlaitDrawElement.isTable(value) || PlaitDrawElement.isSwimlane(value)) {
      return true;
    } else {
      return false;
    }
  ...
  isCustomGeometryElement: (board, value) => {
    ...
    const customGeometryTypes = (options == null ? void 0 : options.customGeometryTypes) || [];
...
var GeometryComponent = class extends CommonElementFlavour {
  constructor() {
    super();
  }
  initializeGenerator() {
    ...
    if (isMultipleTextGeometry(this.element)) {
      ...
      this.textGenerator = new SingleTextGenerator(this.board, this.element, this.element.text, {
        ...
        getMaxWidth: () => {
          ...
          return ((_a = this.element) == null ? void 0 : _a.autoSize) ? GeometryThreshold.defaultTextMaxWidth : width;
        }
      });
    }
  ...
  destroy() {
    ...
    (_a = this.textGenerator) == null ? void 0 : _a.destroy();
  }
};
var debugKey = "debug:plait:line-turning";
var debugGenerator = createDebugGenerator(debugKey);
var ArrowLineComponent = class extends CommonElementFlavour {
  constructor() {
    super();
  ...
  initialize() {
    ...
    this.drawText();
    this.getRef().updateActiveSection = () => {
      const linePoints2 = getArrowLinePoints(this.board, this.element);
      this.activeGenerator.processDrawing(this.element, PlaitBoard.getActiveHost(this.board), {
        selected: this.selected,
  ...
  initializeTextManages() {
    var _a;
    if ((_a = this.element.texts) == null ? void 0 : _a.length) {
      const textManages = [];
  ...
  drawText() {
    var _a;
    if ((_a = this.element.texts) == null ? void 0 : _a.length) {
      this.getRef().getTextManages().forEach((manage, index) => {
...
var VectorLineComponent = class extends CommonElementFlavour {
  constructor() {
    super();
  }
  initializeGenerator() {
...
var withDrawHotkey = (board) => {
  const { keyDown, dblClick } = board;
  board.keyDown = (event) => {
    const selectedElements = getSelectedElements(board);
    const isSingleSelection = selectedElements.length === 1;
    const targetElement = selectedElements[0];
    if (!PlaitBoard.isReadonly(board) && !isVirtualKey(event) && !isDelete(event) && !isSpaceHotkey(event) && isSingleSelection && PlaitDrawElement.isGeometry(targetElement)) {
  ...
  board.dblClick = (event) => {
    ...
    if (!PlaitBoard.isReadonly(board)) {
      ...
      const hitElement = getHitElementByPoint(board, point, void 0, false);
      if (hitElement && PlaitDrawElement.isGeometry(hitElement) && isDrawElementIncludeText(hitElement)) {
        if (isMultipleTextGeometry(hitElement)) {
          const hitText = getHitMultipleGeometryText(hitElement, point) || hitElement.texts.find((item) => item.id.includes(GeometryCommonTextKeys.content)) || hitElement.texts[0];
...
var withGeometryCreateByDrag = (board) => {
  ...
  board.globalPointerUp = (event) => {
    if (isGeometryDndMode(board) && temporaryElement) {
      ...
      fakeCreateTextRef == null ? void 0 : fakeCreateTextRef.textManage.destroy();
      fakeCreateTextRef == null ? void 0 : fakeCreateTextRef.g.remove();
...
var withGeometryCreateByDrawing = (board) => {
  ...
  let snapG;
  board.keyDown = (event) => {
    isShift = (0, import_is_hotkey.isKeyHotkey)("shift", event);
    keyDown(event);
  };
  board.keyUp = (event) => {
    isShift = false;
...
var withDrawFragment = (baseBoard) => {
  ...
  board.buildFragment = (clipboardContext, rectangle, operationType, originData) => {
    ...
    if (targetDrawElements.length) {
      ...
      const elements = buildClipboardData2(board, selectedElements, rectangle ? [rectangle.x, rectangle.y] : [0, 0]);
  ...
  board.insertFragment = (clipboardData, targetPoint, operationType) => {
    ...
    if ((_b = clipboardData == null ? void 0 : clipboardData.elements) == null ? void 0 : _b.length) {
      const drawElements = (_c = clipboardData.elements) == null ? void 0 : _c.filter((value) => PlaitDrawElement.isDrawElement(value));
      if (clipboardData.elements && clipboardData.elements.length > 0 && drawElements.length > 0) {
        insertClipboardData2(board, drawElements, targetPoint);
      }
    }
...
var getBoundedArrowLineElements = (board, plaitShapes) => {
...
var withArrowLineCreateByDraw = (board) => {
  ...
  board.pointerMove = (event) => {
    lineShapeG == null ? void 0 : lineShapeG.remove();
    lineShapeG = createG();
...
var withArrowLineResize = (board) => {
  ...
  const options = {
    ...
    beforeResize: (resizeRef) => {
      if (resizeRef.element.shape === ArrowLineShape.elbow && resizeRef.handle !== LineResizeHandle.source && resizeRef.handle !== LineResizeHandle.target) {
    ...
    onResize: (resizeRef, resizeState) => {
      ...
      if (resizeRef.handle === LineResizeHandle.source || resizeRef.handle === LineResizeHandle.target) {
        ...
        if (hitElement) {
          ...
          object.connection = void 0;
          object.boundId = void 0;
        }
      } else {
      ...
      if (!hitElement) {
        ...
        if (resizeRef.element.shape !== ArrowLineShape.elbow || resizeRef.element.shape === ArrowLineShape.elbow && newPoints.length === 2) {
...
var withArrowLineBoundReaction = (board) => {
  const { pointerMove, pointerUp } = board;
  let boundShapeG = null;
  board.pointerMove = (event) => {
    boundShapeG == null ? void 0 : boundShapeG.remove();
    if (PlaitBoard.isReadonly(board)) {
      pointerMove(event);
      return;
    }
  ...
  board.dblClick = (event) => {
    ...
    if (!PlaitBoard.isReadonly(board)) {
      ...
      if (hitTarget && PlaitDrawElement.isArrowLine(hitTarget)) {
        ...
        const texts = ((_a = hitTarget.texts) == null ? void 0 : _a.length) ? [...hitTarget.texts] : [];
        ...
        if (isHitText) {
          ...
          const textMemory = ((_b = getMemorizedLatest("arrow-line")) == null ? void 0 : _b.text) || {};
          const textElement = buildText(defaultLineText, void 0, textMemory);
...
var ImageComponent = class extends CommonElementFlavour {
  constructor() {
    super();
  }
  initializeGenerator() {
...
var WithArrowLineAutoCompletePluginKey = "plait-arrow-line-auto-complete-plugin-key";
var BOARD_TO_PRE_COMMIT = /* @__PURE__ */ new WeakMap();
var withArrowLineAutoComplete = (board) => {
  const { pointerDown, pointerMove, globalPointerUp } = board;
  ...
  board.globalPointerUp = (event) => {
    ...
    if (temporaryElement) {
      ...
      clearSelectedElement(board);
      addSelectedElement(board, temporaryElement);
      const afterComplete = (_a = board.getPluginOptions(WithArrowLineAutoCompletePluginKey)) == null ? void 0 : _a.afterComplete;
...
var PREVIEW_ARROW_LINE_DISTANCE = 100;
var withArrowLineAutoCompleteReaction = (board) => {
  ...
  board.pointerMove = (event) => {
    reactionG == null ? void 0 : reactionG.remove();
    PlaitBoard.getBoardContainer(board).classList.remove(CursorClass.crosshair);
    const selectedElements = getSelectedDrawElements(board);
    temporaryArrowLineG == null ? void 0 : temporaryArrowLineG.remove();
    temporaryShapeG == null ? void 0 : temporaryShapeG.remove();
    ...
    if (!PlaitBoard.isReadonly(board) && !isSelectionMoving(board) && originElement && PlaitDrawElement.isShapeElement(originElement)) {
      ...
      if (hitPoint) {
        ...
        if (PlaitDrawElement.isGeometry(originElement) && !PlaitDrawElement.isText(originElement)) {
          ...
          const temporaryShapePoints = originElement.points.map((point) => moveXOfPoint(point, PREVIEW_ARROW_LINE_DISTANCE + getXDistanceBetweenPoint(originElement.points[0], originElement.points[1], isHorizontalDirection(arrowLineDirection)), arrowLineDirection));
...
var withArrowLineTextMove = (board) => {
  let textIndex = 0;
...
var withDrawRotate = (board) => {
  ...
  const canRotate = () => {
    const elements = getSelectedElements(board);
    return elements.length > 0 && elements.every((el) => PlaitDrawElement.isDrawElement(el) && !PlaitDrawElement.isArrowLine(el) || PlaitDrawElement.isCustomGeometryElement(board, el));
  };
  board.pointerDown = (event) => {
...
var TableComponent = class extends CommonElementFlavour {
  constructor() {
    super();
  }
  initializeGenerator() {
  ...
  getDrawShapeTexts(cells) {
    return cells.filter((item) => isCellIncludeText(item)).map((item) => {
      return {
        id: item.id,
        text: item.text,
  ...
  onContextChanged(value, previous) {
    if (value.element !== previous.element || value.hasThemeChanged) {
      ...
      if (previousSelectedCells == null ? void 0 : previousSelectedCells.length) {
      ...
      if (!hasSameSelected || (currentSelectedCells == null ? void 0 : currentSelectedCells.length) || value.selected) {
...
function withTableResize(board) {
  ...
  const options = {
    ...
    onResize: (resizeRef, resizeState) => {
      ...
      if (((_a = resizeRef.options) == null ? void 0 : _a.cell) && resizeRef.rectangle) {
        const handleIndex = getIndexByResizeHandle(resizeRef.handle);
        const { originPoint, handlePoint } = getResizeOriginPointAndHandlePoint(board, handleIndex, resizeRef.rectangle);
        const resizePoints = [resizeState.startPoint, resizeState.endPoint];
        const { xZoom, yZoom } = getResizeZoom(resizePoints, originPoint, handlePoint, false, false);
        const originPoints = (_b = resizeRef.options) == null ? void 0 : _b.cell.points;
        ...
        if (offsetX !== 0 && width >= MIN_CELL_SIZE) {
          const { columns, points } = updateColumns(resizeRef.element, (_c = resizeRef.options) == null ? void 0 : _c.cell.columnId, width, offsetX);
          Transforms.setNode(board, { columns, points }, path);
        } else if (offsetY !== 0 && height >= MIN_CELL_SIZE) {
          const { rows, points } = updateRows(resizeRef.element, (_d = resizeRef.options) == null ? void 0 : _d.cell.rowId, height, offsetY);
...
var withTable = (board) => {
  ...
  tableBoard.keyDown = (event) => {
    ...
    const isSingleSelection = selectedElements.length === 1;
    const targetElement = selectedElements[0];
    if (!PlaitBoard.isReadonly(board) && !PlaitBoard.hasBeenTextEditing(tableBoard) && !isVirtualKey(event) && !isDelete(event) && !isSpaceHotkey(event) && isSingleSelection) {
      event.preventDefault();
...
var withSwimlaneCreateByDrawing = (board) => {
  const { pointerDown, pointerMove, pointerUp, keyDown, keyUp } = board;
  let start = null;
  let swimlaneG = null;
  let temporaryElement = null;
...
var withVectorLineCreateByDraw = (board) => {
  ...
  board.globalKeyDown = (event) => {
    if (!PlaitBoard.isReadonly(board)) {
      const isEsc = (0, import_is_hotkey.isKeyHotkey)("esc", event);
      const isV = (0, import_is_hotkey.isKeyHotkey)("v", event);
...
var withVectorLineResize = (board) => {
  const options = {
...
var withDraw = (board) => {
  ...
  board.getRelatedFragment = (elements, originData) => {
    const selectedElements = (originData == null ? void 0 : originData.length) ? originData : getSelectedElements(board);
...
export {
  ...
  DefaultPentagonArrowProperty,
  DefaultTwoWayArrowProperty,
  DefaultArrowProperty,
  DefaultCloudProperty,
  DefaultTextProperty,
  GeometryThreshold,
  DefaultConnectorProperty,
  DefaultFlowchartProperty,
  DefaultDataBaseProperty,
  DefaultInternalStorageProperty,
  DefaultDecisionProperty,
  DefaultDataProperty,
  DefaultDocumentProperty,
  DefaultNoteProperty,
  DefaultMultiDocumentProperty,
  DefaultManualInputProperty,
  DefaultMergeProperty,
  DefaultActorProperty,
  DefaultContainerProperty,
  DefaultPackageProperty,
  DefaultActivationProperty,
  DefaultObjectProperty,
  DefaultComponentBoxProperty,
  DefaultDeletionProperty,
  DefaultPortProperty,
  DefaultRequiredInterfaceProperty,
  DefaultAssemblyProperty,
  DefaultProvidedInterfaceProperty,
  DefaultCombinedFragmentProperty,
  DefaultClassProperty,
  DefaultInterfaceProperty,
  DefaultBasicShapePropertyMap,
  DefaultFlowchartPropertyMap,
  DefaultUMLPropertyMap,
  MultipleTextGeometryTextKeys,
  LINE_HIT_GEOMETRY_BUFFER,
  LINE_SNAPPING_BUFFER,
  LINE_SNAPPING_CONNECTOR_BUFFER,
  ...
  getVectorLinePointers,
  DEFAULT_IMAGE_WIDTH,
  DrawThemeColors,
  SWIMLANE_HEADER_SIZE,
  DefaultSwimlaneVerticalWithHeaderProperty,
  DefaultSwimlaneHorizontalWithHeaderProperty,
  DefaultSwimlaneVerticalProperty,
  DefaultSwimlaneHorizontalProperty,
  DefaultSwimlanePropertyMap,
  MIN_TEXT_WIDTH,
  DefaultLineStyle,
  LINE_TEXT_SPACE,
  LINE_AUTO_COMPLETE_DIAMETER,
  LINE_AUTO_COMPLETE_OPACITY,
  LINE_AUTO_COMPLETE_HOVERED_OPACITY,
  LINE_AUTO_COMPLETE_HOVERED_DIAMETER,
  LINE_ALIGN_TOLERANCE,
  LINE_TEXT,
  KEY_TO_TEXT_MANAGE,
  setTextManage,
  getTextManage,
  ...
  updateColumns,
  updateRows,
  updateCellIdsByRowOrColumn,
  updateRowOrColumnIds,
  updateCellIds,
  isCellIncludeText,
  getCellsRectangle,
  createCell,
  ...
  getHitConnectorPoint,
  getArrowLineTextRectangle,
  getArrowLines,
  Q2C,
  handleArrowLineCreating,
  isMultipleTextShape,
  isMultipleTextGeometry,
  getMultipleTextGeometryTextKeys,
  createMultipleTextGeometryElement,
  buildDefaultTextsByShape,
  getHitMultipleGeometryText,
  getVectorLinePoints,
  createVectorLineElement,
  vectorLineCreating,
  drawVectorLine,
  isTextExceedingBounds,
  isHitArrowLineText,
  isHitPolyLine,
  isHitArrowLine,
  isHitVectorLine,
  isRectangleHitElementText,
  isHitElementText,
  isEmptyTextElement,
  isRectangleHitDrawElement,
  isRectangleHitRotatedElement,
  isRectangleHitRotatedPoints,
  getHitDrawElement,
  getFirstFilledDrawElement,
  isFilledDrawElement,
  getSolidElements,
  isHitDrawElement,
  isHitEdgeOfShape,
  ...
  getSelectedSwimlane,
  buildSwimlaneTable,
  getDefaultSwimlanePoints,
  createDefaultSwimlane,
  createDefaultRowsOrColumns,
  createDefaultCells,
  getSwimlaneCount,
  isSwimlaneWithHeader,
  isSwimlaneShape,
  adjustSwimlaneShape,
  isSwimlanePointers,
  DrawTransforms,
  debugGenerator$1,
  getSnapResizingRefOptions,
  getSnapResizingRef,
  buildClipboardData2 as buildClipboardData,
  insertClipboardData2 as insertClipboardData,
  getArrowLineHandleRefPair,
  getConnectionPoint,
  getVectorByConnection,
...
//# sourceMappingURL=chunk-ZENJNSGT.js.map
